...
class GANCardGUI:
    ...
    def generate_random_gif(self)->Image:
        try:
            ...
            frames = self.generate_gif_frames(self.current_seed, self.current_n_steps, self.current_n_keypoints, temp_dir)
            ...
            #frames = hide_animation_params_in_gif(frames, self.current_seed, self.current_n_steps, self.current_n_keypoints, self.current_fps)
            ...
            frames[0].save(
                ...
                duration=int(1000 / self.current_fps),  # 100ms pro Frame
                loop=0
            )
    ...
    def generate_gif_frames_from_keypoints(self, keypoints, n_steps, temp_dir):
        frames = []
    ...
    def generate_static_image(self) -> None:
        try:
            ...
            if file_ext == ".json":
                ...
                frames = self.generate_gif_frames_from_keypoints(self.current_keypoints, self.current_n_steps, tempfile.mkdtemp())
